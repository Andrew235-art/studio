            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-muted-foreground mt-4 max-w-3xl mx-auto text-lg">
                        We're looking for compassionate and reliable individuals to join the Stamerck Enterprise family. Help us make a difference, one ride at a time.
                    </p>
                </div>
                ...
                <div className="text-center">
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                        Don't see a position that fits your profile? Send your resume to <a href="mailto:bookings@stamerck.com" className="text-primary hover:underline">bookings@stamerck.com</a> and we'll keep it on file for future openings.
                    </p>
                </div>
            </div>
        </div>
